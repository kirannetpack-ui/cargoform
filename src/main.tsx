  ...
  return (
    <div className="app">
      <aside>
        ...
        {!DIRECT_WEB_ACCESS && <button className="logout-button" onClick={async()=>{await fetch(`${apiBase}/auth/logout`,{method:"POST",credentials:"include"});setSessionInfo(null);setLoggedIn(false);setActiveSection("Shipment data");}}>
          Logout
        </button>}
      </aside>
      <main>
