...
// Some managed runtimes reserve or strip generic BOOTSTRAP_* variables.
// Prefer CargoForm-scoped names while retaining the original names for
// self-hosted and existing installations.
const email = (
  process.env.CARGOFORM_ADMIN_SETUP_EMAIL ||
